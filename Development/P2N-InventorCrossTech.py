...
if ficOk:
    ...
    appariement['inventor-IPCR1'] = ['inventeur','IPCR1']
    appariement['inventor-IPCR4'] = ['inventeur','IPCR4']
    appariement['inventor-IPCR11'] = ['inventeur','IPCR11']
...
#""")
    ...
    try:
        os.remove(ResultPathGephi+'\\'+ndf.replace('.dump', '')+"_InventorsCrossTech"+ndf.replace('.dump', '')+'.gexf')
    except:
        pass
        
    os.rename(ResultPathGephi+'\\'+"Good"+ndf+'2.gexf', ResultPathGephi+'\\'+ndf.replace('.dump', '')+"_InventorsCrossTech"+'.gexf')
    print "Network file writen in ",  ResultPathGephi+' directory.\n See file: '+ndf.replace('.dump', '')+"InventorsCrossTech"+'.gexf'
